    ...
    if инлайн_запрос.data == 'отправить_рассылку':
        if "режим_рассылки" in context.user_data and context.user_data["режим_рассылки"] == 1:
            ...
            for id_пользователя in id_пользователей:
                await context.bot.copy_message(id_пользователя[0], update.effective_chat.id, инлайн_запрос.message.id,
                                               reply_markup=None)
...
async def событие_юнити(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message and update.message.chat.type == 'supergroup' or update.message and update.message.chat.type == 'group':
        if "ввод_пароля" in context.user_data and context.user_data["ввод_пароля"] == 1:
            if update.message.text == "m0gYLnZiLyBRJANPvmwD":
    ...
    if update.effective_chat.id != id_анкетной_группы:
        ...
        if context.user_data["этап_анкеты"] == 1:
        ...
        if context.user_data["этап_анкеты"] == 2:
        ...
        if context.user_data["этап_анкеты"] == 3:
        ...
        if context.user_data["этап_анкеты"] == 4:
        ...
        if context.user_data["этап_анкеты"] == 5:
        ...
        if context.user_data["обращение_в_техподдержку"] == 1:
        ...
        # ВОПРОС СТРАНА
        if context.user_data["заполнение_заявки"] == 1:
        ...
        # ВОПРОС ДАТА
        if context.user_data["заполнение_заявки"] == 2:
        ...
        # ВОПРОС НОМЕР
        if context.user_data["заполнение_заявки"] == 3:
        ...
        # ВОПРОС E-MAIL
        if context.user_data["заполнение_заявки"] == 4:
        ...
        if context.user_data["заполнение_заявки"] == 5:
        ...
        # ВОПРОС ФОТО ПАСПОРТ
        if context.user_data["заполнение_заявки"] == 6:
        ...
        if context.user_data["заполнение_заявки"] == 7:
        ...
        if context.user_data["заполнение_заявки"] == 8:
            if update.message.photo or update.message.document:
        ...
        if context.user_data["заполнение_заявки"] == 9:
        ...
        # ВОПРОС 4500$
        if context.user_data["заполнение_заявки"] == 10:
            if update.message.photo or update.message.document:
        ...
        if context.user_data["заполнение_заявки"] == 11:
            if update.message.photo or update.message.document:
                ...
                # media_group = [InputMediaPhoto(media=photo) for photo in список]
                # await context.bot.send_media_group(id_анкетной_группы, media_group)
                ...
                await context.bot.send_message(id_анкетной_группы,
                                               f"Внимание! Новая заявка\n\n{имя_заявка}\n{страна_заявка}\n{дата_рождения_заявка}\n{номер_заявка}\n{маил_заявка}\n{предыдущая_страна_обучения_заявка}")
    ...
    if update.effective_chat.id == id_анкетной_группы:
        ...
        if update.message and update.message.reply_to_message and update.message.reply_to_message.forward_from:
            await context.bot.send_message(update.message.reply_to_message.forward_from.id, "#Ответ_техподдержки")
        ...
        if context.chat_data["изменение_faq"] == 1:
        ...
        if context.chat_data["изменение_faq"] == 2 and context.chat_data["запись_вопроса"] == 1:
            await context.bot.copy_message(update.effective_chat.id, update.effective_chat.id,
                                           update.message.message_id,
        ...
        if context.chat_data["изменение_faq"] == 2 and context.chat_data["запись_ответ"] == 1:
            await context.bot.copy_message(update.effective_chat.id, update.effective_chat.id,
                                           update.message.message_id,
        ...
        if context.user_data["добавление_faq"] == 1:
            await context.bot.send_message(update.effective_chat.id, "Напшии сообщение с вопросом ниже⤵️",
        ...
        if context.user_data["добавление_faq"] == 2 and context.user_data["запись_вопроса_добавление"] == 1:
            await context.bot.copy_message(update.effective_chat.id, update.effective_chat.id,
                                           update.message.message_id,
        ...
        if context.user_data["добавление_faq"] == 2 and context.user_data["запись_ответ_добавление"] == 1:
            await context.bot.copy_message(update.effective_chat.id, update.effective_chat.id,
                                           update.message.message_id,
